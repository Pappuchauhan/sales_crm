...
$db = getDbInstance();
$select = array('id', 'package_name', 'permit', 'guide', 'bike', 'lunch', 'water_bottle', 'tea', 'bon_fire', 'oxygen_cyliender', 'duration', 'no_name1', 'no_name2', 'no_name3', 'no_name4', 'no_name5', 'created_at', 'updated_at');
